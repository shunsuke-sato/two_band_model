...
! Material parameters
  ...
  real(8),parameter :: eps_g = 4.45d0/(2d0*Ry)  !1.52d0/(2d0*Ry) 
  real(8),parameter :: mass_r = 0.26d0  !1d0/(1d0/0.13d0+1d0/0.45d0)
  real(8),parameter :: piz_vc = 0d0 
  real(8),parameter :: pix_vc = 0.5d0*sqrt(eps_g/mass_r)
